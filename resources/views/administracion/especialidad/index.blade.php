    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex flex-row-reverse">
                <a href="{{ route('especialidad.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Nuevo</a>
            </div>
                ...
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    @foreach ($specialties as $specialty)
                        <tr>
                            ...
                            <td>{{$specialty->description??"Ninguna"}}</td>
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('especialidad.edit',$specialty->id) }}" class="pr-1">
                                        <i class="fa fa-pencil icon-size"></i>
                                    </a>
                                    <form action="{{ route('especialidad.destroy',$specialty->id) }}" method="POST">
                                        @csrf
                                        {{ method_field('DELETE') }}
